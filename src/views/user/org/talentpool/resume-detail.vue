<template>
  <div class="hk-org-resume" ref="resume">
    <div class="hk-detail-bar content" id="state" ref="myMenu">
      <div class="hk-detail-title-conten" id="boxFixed" >
          <div>快速反馈</div>
      ...
      <div id="resumes" class="hk-detail-title"  >
        ...
        <!-- 头像以及基本资料 -->
        <userInfo class="org-resume-detail" ref="d_jump" :userInfo="userInfoLists"></userInfo>
        <!-- 求职意向 -->
        <jwIntention class="org-resume-detail" ref="d_jump" :jwList="jwList"></jwIntention>
        <!-- 求职状态 -->
        <workState class="org-resume-detail" ref="d_jump" :jobWantState="jobWantState"></workState>
        <!-- 教育经历 -->
        <education class="org-resume-detail" ref="d_jump" :eduLists="educationList" @educontent="receiveEduData"></education>
        <!-- 工作经历 -->
        <workFor class="org-resume-detail" ref="d_jump" :workList="workList" @workcontent="receiveWorkForData"></workFor>
        <!-- 项目经历 -->
        <myProject class="org-resume-detail" ref="d_jump" :projectList="projectList" @project="receiveProjectData"></myProject>
        <!-- 我的证书 -->
        <myCert class="org-resume-detail" ref="d_jump" :certList="certList" @cert="receiveCertData"></myCert>
      </div>
    </div>
