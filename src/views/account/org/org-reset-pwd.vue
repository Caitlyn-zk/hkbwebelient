<template>
  <div class="rerieve-pwd">
    <div class="content">
      <div class="tiling">
        <div class="tiling">
          <div class="font-30 text-bold margin-r-20 text-white"><router-link class="text-white" to="/">环科宝</router-link></div>
          <div class="platform-introduce text-white">水与环境行业专业信息服务平台</div>
        </div>
        <div class="title text-white">找回密码</div>
      </div>
      <div class="form form-border">
        <el-form ref="form" :rules="rules" :model="form">
          ...
          <el-form-item prop="phone">
            <el-input type="tel" v-model="form.phone" readonly onfocus="this.removeAttribute('readonly')" autocomplete="off" placeholder="请输入注册时使用的手机号"></el-input>
          </el-form-item>
          <el-form-item prop="code">
            <el-input type="text" v-model="form.code" readonly onfocus="this.removeAttribute('readonly')" autocomplete="off" placeholder="请输入短信验证码">
          ...
          <el-form-item prop="pass">
            <el-input type="password" v-model="form.pass" readonly onfocus="this.removeAttribute('readonly')" autocomplete="off" placeholder="请输入新密码"></el-input>
          </el-form-item>
