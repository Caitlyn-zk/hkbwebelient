  ...
  <div class="hk-backstagenv">
      <div class="hk-backstagenv-fixed">
        <el-menu
          ...
          <el-menu-item index="1"  class="padding-l-10 hk-header"><router-link class="hk-nav-a" to="/user/org/index">首页</router-link></el-menu-item>
          <el-submenu index="2">
            <template slot="title">项目管理</template>
            <el-menu-item index="2-1"><router-link class="hk-rout-link-fb hk-nav-a" to="/user/org/project">项目列表</router-link></el-menu-item>
            <el-menu-item index="2-2" @click="peleaseProject"><router-link class="hk-rout-link-fb hk-nav-a" :to="{path:'/user/org/project/add',query:{proid:0}}">发布项目</router-link></el-menu-item>
          </el-submenu>
          <el-menu-item index="3" ><router-link class="hk-nav-a" to="/user/org/notice/list">环评公示</router-link></el-menu-item>
          <el-menu-item index="4" ><router-link class="hk-nav-a" to="">学院</router-link></el-menu-item>
          
          <el-submenu index="5">
            <template slot="title">人才库管理</template>
            <el-menu-item index="5-1"><router-link class="hk-rout-link-fb hk-nav-a text-white" to="/user/org/talentpool">平台人才库</router-link></el-menu-item>
            <el-menu-item index="5-1"><router-link class="hk-rout-link-fb hk-nav-a " to="/user/org/talentpool/resumeInbox">收信箱</router-link></el-menu-item>
            <el-menu-item index="5-1"><router-link class="hk-rout-link-fb hk-nav-a" to="/user/org/talentpool/collection">人才收藏</router-link></el-menu-item>
          </el-submenu>
          
          <!-- <el-menu-item index="5" ><router-link class="hk-nav-a" to="/user/org/talentpool">简历管理</router-link></el-menu-item> -->
          <el-menu-item index="6" ><router-link class="hk-nav-a" to="/user/org/post/manage">职位管理</router-link></el-menu-item>
            ...
            <span class="hk-org-nav-news font-14">
              <span class="hk-jianxiquchu">
                <el-dropdown :hide-on-click="false" class="hk-myname" style="color: #fff;">
                  ...
                  <el-dropdown-menu slot="dropdown" class="hk-person-news" style="width: 200px;min-height: 100px;">
                    <el-dropdown-item>消息0001</el-dropdown-item>
                    <!-- <el-dropdown-item>消息000004</el-dropdown-item> -->
                  </el-dropdown-menu>
                </el-dropdown>
                <el-dropdown :hide-on-click="false" class="hk-myname" style="color: #fff;">
                ...
                <el-dropdown :hide-on-click="false" class="hk-myname" style="color: #fff;">
                  <span class="el-dropdown-link hk-cursor clearfix">
                    <!-- 控制显示字数 -->
                    <div class="fl text-center padding-lr-12 hk-org-name" style="">
                        {{org_name}}
                    </div>
                    <i class="el-icon-caret-bottom"></i>
                  </span>
                  <el-dropdown-menu slot="dropdown">
                    <!-- <el-dropdown-item><router-link class="text-blacks" to="/user/person/index">详细情况</router-link></el-dropdown-item> -->
                    <el-dropdown-item><router-link class="text-blacks" :to="{path:'/user/org/account/index'}">账户中心</router-link></el-dropdown-item>
                    <!-- <el-dropdown-item><router-link class="text-blacks" to="/user/person/my/resume">修改资料</router-link></el-dropdown-item> -->
                    <el-dropdown-item><router-link class="text-blacks" :to="{path:'/user/org/account/setting'}">修改资料</router-link></el-dropdown-item>
...
export default {
  ...
  methods: {
    ...
    getRouter () {
      ...
      window.localStorage.setItem('defaultActive', this.defaultActive)
    },
    // 退出登录
    onLogout () {
      logout().then( res => {
