<template>
    <div class="dialog">
        <el-dialog  :visible.sync="skill.eject" title="技能标签" :lock-scroll="true" :append-to-body="skill.type == 0" :close-on-click-modal="false"  :before-close="onClose" @open="onOpen" >
            <div class="skill">
                <div class="tips">选择你的技能标签</div>
                <div class="skill-tiling">
                    <el-input v-model="inputValue" placeholder="请输入技能标签"  maxlength="10" show-word-limit class="skill-input"></el-input>
