<template>
    <div class="binding-phone">
        <el-dialog :visible.sync="emailPopup" width="500px" :lock-scroll="true"  :close-on-click-modal="false" :before-close="beforeClose" >
            <div class="title">修改邮箱</div>
            <el-form ref="form" :rules="rules" :model="form" class="form" label-width="90px">
