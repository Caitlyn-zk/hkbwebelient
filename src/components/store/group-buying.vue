      ...
      <div class="group-conetent">
        ...
        <div class="rotation-main">
          ...
          <div class="containt-list">
            ...
            >
              <li class="content-right-goods" v-for="item in timeList" :key="item">
                <div class="goods-img">
                  <img src="../../assets/image/stoer-goods-02.png" alt />
                  <!-- 小图标 -->
                  <div class="min-img-icon">
                    <img src="../../assets/image/groupbuying.png" alt />
                  </div>
                </div>
                <p class="goods-name title-nowrap text-center margin-t-6">沼气收集利用厂家介绍沼气工程配套施工方案图纸</p>
